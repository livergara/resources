...
declare const _default: import("vue").DefineComponent<import("vue").ExtractPropTypes<{
    /**
     * Редактируемое значение, может быть числом или null
     * При инциализации если в значении строка - пытается привести её к числу, если не получается - переводит в null
     */
    modelValue: {
    ...
    /**
     * Встроенная валидация значения - минимальное значение, значение контрола должно быть больше или равно указанному
     */
    min: {
    ...
    /**
     * Встроенная валидация значения - максимальное значение, значение контрола должно быть меньше или равно указанному
     */
    max: {
        type: PropType<number | string | null>;
        default: null;
     ...
     */
    validationRules: {
        type: PropType<IGaValidateFunction<number>[] | IGaValidateFunction<number> | null>;
        default: null;
    };
    /**
     * Точность числа, больше которой указать нельзя будет, указывается разрешенное количество знаков после запятой
     * по умолчанию 2 значка после запятой - 0.01
     */
    precision: {
    ...
    readonlyValue: import("vue").ComputedRef<string | number>;
    ...
    modelValueLocal: import("vue").Ref<number | null, number | null>;
    inputRef: import("vue").Ref<any, any>;
    handleChange: import("vue").ComputedRef<import("lodash").DebouncedFunc<(value: number | null) => Promise<void>>>;
    ...
    validationRules: IGaValidateFunction<number> | IGaValidateFunction<number>[] | null;
    tooltip: string;
    readonly: boolean;
    placeholder: string;
    clearable: boolean;
