...
declare const _default: import("vue").DefineComponent<import("vue").ExtractPropTypes<{
    ...
    tooltipIconRef: import("vue").Ref<any, any>;
    componentId: string;
    ...
    GaPopup: import("vue").DefineComponent<import("vue").ExtractPropTypes<{
        ...
        target: {
            type: PropType<string | HTMLElement | import("vue").Ref<HTMLElement>>;
            default: null;
        };
        name: {
            type: StringConstructor;
        ...
        componentId: string;
        popupEl: import("vue").Ref<HTMLElement | null, HTMLElement | null>;
        popupPointerClasses: import("vue").ComputedRef<Record<string, boolean>>;
        visibleLocal: import("vue").Ref<boolean, boolean>;
        ...
        name: string;
        visible: boolean;
        target: string | HTMLElement | import("vue").Ref<HTMLElement, HTMLElement>;
        offset: number;
        showPointer: boolean;
        position: "top" | "right" | "bottom" | "left";
        valign: "top" | "bottom" | "auto" | "middle";
